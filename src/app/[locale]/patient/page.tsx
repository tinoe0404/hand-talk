                    ...
                    {currentInstructionId ? (
                        ...
                        <div className="w-full max-w-5xl space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                            ...
                            <div className="flex items-center justify-center gap-4 mb-4">
                                <div className="flex items-center gap-2 px-6 py-3 bg-medical-green-900/50 border-2 border-medical-green-700 rounded-full">
                                    <Activity className="w-8 h-8 text-medical-green-400" />
                                    <span className="text-2xl font-bold text-medical-green-100 uppercase tracking-widest">{t("systemActive")}</span>
                                </div>
                            </div>

                            <div className="space-y-6">
                                <h2 className="text-7xl md:text-8xl font-black tracking-tight leading-tight text-white mb-2">
                                    {t("follow")}
                                </h2>
                            </div>
